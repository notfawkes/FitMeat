    ...
    <div className="flex flex-col min-h-screen w-full relative">
      ...
      <main className="flex-grow flex items-center justify-center w-full relative z-10">
        <div className="bg-white rounded-lg shadow-xl overflow-hidden transition-all duration-300 transform w-full max-w-md px-4">
          <div className="p-8">
            <h2 className="text-2xl font-bold text-center text-[#013220] mb-6">Sign In to Your Account</h2>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="#" className="text-xs font-medium text-[#0B6E4F] hover:text-[#013220]">Forgot password?</Link>
                </div>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div className="flex items-center">
                <input id="remember-me-signin" name="remember-me-signin" type="checkbox" className="h-4 w-4 text-[#0B6E4F] focus:ring-[#50C878] border-gray-300 rounded" />
                <label htmlFor="remember-me-signin" className="ml-2 block text-sm text-gray-700">Remember me</label>
              </div>
              <div>
                <button
                  type="submit"
                  className={`w-full flex justify-center items-center gap-2 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#0B6E4F] hover:bg-[#013220] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#50C878] transition-colors duration-200 ${loading ? 'bg-gray-400 cursor-not-allowed' : ''}`}
                  disabled={loading}
                >
              ...
              <div className="text-center mt-4">
                <p className="text-sm text-gray-600">
                  ...
                  <Link to="/register" className="font-medium text-[#0B6E4F] hover:text-[#013220] focus:outline-none focus:underline transition-colors duration-200">
                    Sign Up
                  </Link>
                </p>
              </div>
